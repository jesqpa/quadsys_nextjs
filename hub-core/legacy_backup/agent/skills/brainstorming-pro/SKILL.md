...
---
# Brainstorming y Planificación Pro
...
- Ejemplos de lo que SÍ y lo que NO (si el usuario tiene preferencias).
...
3) Filtra y puntúa cada idea (1–5) en: Impacto, Claridad, Novedad, Esfuerzo, Viabilidad.
4) Devuelve un TOP 5 final con: Idea (1 línea), por qué funciona (2 líneas), primer paso (1 línea).
