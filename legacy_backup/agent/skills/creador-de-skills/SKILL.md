...
description: Actúa como Meta-Skill para generar otros skills dentro de Antigravity con una estructura estandarizada, clara y predecible.
---
...
1. Para crear un skill nuevo, pide:
   *“Usa este skill 'creador-de-skills' y construye un skill para: <TEMA>. Devuélveme la carpeta, el SKILL.md y los recursos necesarios.”*
